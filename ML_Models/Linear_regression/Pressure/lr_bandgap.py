...
plt.figure()
plt.scatter(y, y_pred, alpha=0.75, label='Linaer regression')
plt.plot(y, y, color='k')#,label="Perfect")
font = {'family' : 'normal',
        'size'   : 20}
plt.legend(fontsize=16)
txt = "$R^2$={r:.4f}\nMAD/MAE={ratio:.2f}"
plt.annotate(txt.format(r = r2,ratio=ratio), xy=(0.05, 0.7), xycoords='axes fraction',fontsize=16)
plt.xlabel('Calculated bandgap (eV)',fontsize=16)
